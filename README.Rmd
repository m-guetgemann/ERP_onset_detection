...
This document gives an overview of all scripts that were used for the current project, data files were uploaded to the Open Science Framework (link below). MATLAB scripts were used to pre-process raw ERP CORE data files, to perform mass-univariate analyses and permutation testing and create figures of the results. R Scripts were used to obtain onset estimates with change point detection, to implement cluster-sum permutation testing and maximum statistics correction. Quarto Notebooks were used during intermediate steps of analysis and to showcase figures of exemplary participants. Acknowledgements go out to my supervisor, Guillaume Rousselet, who guided and supported this project.

This README gives information about code for the following files:
- Preprocessing_ERP_Core.m
- Permutations_and_analysis.m
- Plot_diff_waves.m
- SVM_decoding.m
- onset_estimation.R
- plotting_univariate_significance.R
- r_onset_results.qmd

## Data 

Data was originally download from: "Raw data and analysis scripts" files from the the Open Science Foundation repository, at https://osf.io/thsqg/

Preprocessed EEG data, permutation and analysis results and figures are all available as zip file for download at https://osf.io/wcd82/?view_only=dfd0d71993a54142962d4fc8d8c6b483. The zip folders should be downloaded to the folder "All_components_files" to keep the path setup intact.
...
Data is shared under the terms of a Creative Commons license (CC BY-SA 4.0, https://creativecommons.org/licenses/by-sa/4.0/).

The following gives an overview of all scripts involved in the project 'ERP_onset_detection'. This includes pre-processing raw EEG data from the open access ERP CORE repository, analysis in MATLAB, further analysis and processing of results in R.
...
### Output 
- results for each participant are saved as .mat file in the folder perm_results of each EPR component folder
- variables are saved in `res` structure
